...
**Girdi (Komut):**
```bash
msp430-readelf -h udp-client.z1
```
...
**Girdi (Komut):**
```bash
msp430-readelf -S udp-client.z1
```
...
Section Headers:
  ...
  [ 5] .noinit           NOBITS          0000294e 00a7f2 000002 00  WA  0   0  2
...
**Girdi (Komut):**
```bash
msp430-nm -n udp-client.z1
```

**Çıktı (Terminal - Kesit):**
```text
...
0000d24a R button_sensor
0000d258 R cc2420_driver
...
0000d6ee A __data_load_start
0000d6ee A _etext
...
0000ba12 T uip_udp_packet_send
0000ba3c T uip_udp_packet_sendto
0000bc82 T uip_udp_new
...
```
...
**Girdi (Komut):**
```bash
msp430-objdump -d udp-client.z1 | head -n 30
```
...
00003100 <__watchdog_support>:
    ...
    3108:       82 45 4e 29     mov     r5,     &0x294e
